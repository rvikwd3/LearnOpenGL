...
* Setup end }}}*/
	...
	// ------------------------------------------
	unsigned int points_VBO, colors_VBO, VAO, EBO;
    glGenBuffers(1, &EBO);


	// Bind VBOs to targets GL_ARRAY_BUFFER
	// ------------------------------------
	glGenBuffers(1, &points_VBO);
	glBindBuffer(GL_ARRAY_BUFFER, points_VBO);
	glBufferData(GL_ARRAY_BUFFER,   // Copy vertex data into VBO
				12*sizeof(float),
				vertices,
				GL_STATIC_DRAW
	);
	...
	glBufferData(GL_ARRAY_BUFFER,   // Copy color data into VBO
				12*sizeof(float),
				colors,
				GL_STATIC_DRAW
	);
